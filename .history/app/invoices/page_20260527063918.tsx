      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Link
            ...
            className="bg-blue-600 text-white font-semibold tracking-wide px-4 py-2 rounded shadow hover:bg-blue-700 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-500"
          >
            + New Invoice
          </Link>
        </div>
