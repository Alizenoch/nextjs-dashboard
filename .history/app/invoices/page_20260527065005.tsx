...
export default async function InvoicesPage() {
  ...
  className="bg-blue-600 text-slate-50 font-extrabold text-lg px-5 py-2 rounded shadow hover:bg-blue-700 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-500"
>
  + New Invoice
</Link>
