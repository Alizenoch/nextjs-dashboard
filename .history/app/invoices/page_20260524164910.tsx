...
import { fetchInvoices } from '../../lib/data'; // ✅ use relative path
  ...
  return (
    <div className="p-6">
      ...
      <table className="w-full border-collapse border">
        ...
        <tbody>
          {invoices.map((i: { id: string; customer: string; amount: number; status: string; date: string }) => (
            <tr key={i.id}>
              ...
              <td className="border p-2">
                <Link href={`/invoices/${i.id}/edit`} className="text-blue-600 hover:underline">
                  Edit
                </Link>
              </td>
            </tr>
