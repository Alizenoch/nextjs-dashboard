    ...
    const chartConfig: ChartConfiguration = {
        ...
        datasets: [
          {
            ...
            backgroundColor: "rgba(59, 130, 246, 0.85)", // clearer blue with opacity
            borderColor: "#3b82f6",
            borderWidth: 1,
      ...
      options: {
        ...
        plugins: {
          legend: {
            labels: {
              color: "red", // force bright white legend text
        ...
        scales: {
          x: {
            ticks: { color: "red", font: { size: 13, weight: "bold" } },
            grid: { color: "#4b5563" }, // lighter gray grid for contrast
          },
          y: {
            ticks: {
              color: "red",
